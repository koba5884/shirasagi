class Schedule::PlanRepeat
  ...
  embeds_one :repeat_on, class_name: 'Schedule::PlanRepeatOn'
  embeds_one :repeat_by, class_name: 'Schedule::PlanRepeatBy'

  has_many :plan, class_name: 'Schedule::Plan', dependent: :destroy
